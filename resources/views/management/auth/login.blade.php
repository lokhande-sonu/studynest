...
<head>
    ...
    <title>Login - StudyNest Management Panel</title><!-- icon -->
    ...
    <div class="min-h-100 p-0 p-sm-6 d-flex align-items-stretch">
        <div class="card w-25x flex-grow-1 flex-sm-grow-0 m-sm-auto">
            ...
            <hr/>
                ...
                <div class="fs-exact-14 text-muted mt-2 pt-1 mb-5 pb-2">Log in to management account to continue.</div>
                ...
                <div class="mb-4"><label class="form-label">Password</label>
                                                                <input class="form-control form-control-lg @error('password') is-invalid @enderror" id="password" name="password" type="password" placeholder="Enter your password" required />
               ...
               @error('password')
                ...
                <div class="mb-4 row py-2 flex-wrap">
                    ...
                    <div class="col-auto d-flex align-items-center"><a href="{{ route('forgot-password') }}">Forgot
                            Password?</a></div>
                </div>
                <div>
                ...
                <div class="form-group mb-0 mt-4 pt-2 text-center text-muted">Copyright {{ date('Y') }} StudyNest <br/>Powered by <a
                        href="https://nextinlabs.com" class="text-danger" target="_blank">NEXTIN LABS</a></div>
            </div>
