                        ...
                        <div class="pe-xl-5">
                            <div class="border border-gray-100 rounded-8 px-40 py-40 mb-24">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-12">
                                        {{-- START: imohitmehto | 2026-08-25 | FEATURE: Address pre-fill from customer profile --}}
                                        <label class="form-label text-heading-two text-sm fw-semibold">Address <span class="text-danger-600">*</span></label>
                                        <input type="text" class="common-input border-gray-200 mb-16" placeholder="House number and street name" name="address" value="{{ old('address', auth()->user()->cust_address ?? '') }}" required>
                                        ...
                                        {{-- END: imohitmehto | FEATURE: Address pre-fill --}}
                                    </div>
                                    <div class="col-sm-6">
                                        {{-- START: imohitmehto | 2026-08-25 | FEATURE: City pre-fill from customer profile --}}
                                        <label class="form-label text-heading-two text-sm fw-semibold">City <span class="text-danger-600">*</span></label>
                                        <input type="text" class="common-input border-gray-200" placeholder="City" name="city" value="{{ old('city', auth()->user()->cust_city ?? '') }}" required>
                                        {{-- END: imohitmehto | FEATURE: City pre-fill --}}
                                    </div>
                                    <div class="col-sm-6">
                                        {{-- START: imohitmehto | 2026-08-25 | FEATURE: State pre-fill from customer profile --}}
                                        <label class="form-label text-heading-two text-sm fw-semibold">State <span class="text-danger-600">*</span></label>
                                        <input type="text" class="common-input border-gray-200" placeholder="State" name="state" value="{{ old('state', auth()->user()->cust_state ?? '') }}" required>
                                        {{-- END: imohitmehto | FEATURE: State pre-fill --}}
                                    </div>
                                    <div class="col-sm-6">
                                        {{-- START: imohitmehto | 2026-08-25 | FEATURE: Pincode pre-fill from customer profile --}}
                                        <label class="form-label text-heading-two text-sm fw-semibold">Pincode <span class="text-danger-600">*</span></label>
                                        <input type="text" class="common-input border-gray-200" placeholder="Pincode" name="pincode" value="{{ old('pincode', auth()->user()->cust_pincode ?? '') }}" required>
                                        {{-- END: imohitmehto | FEATURE: Pincode pre-fill --}}
                                    </div>
                                    <div class="col-sm-6">
