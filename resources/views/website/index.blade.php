                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <form action="{{ route('website.school-shop') }}" method="GET" class="form-location-wrapper max-w-840 w-100 text-center">
                            ...
                            <div class="search-category select-style-one d-flex 
                                    ...
                                    d-sm-flex d-none text-heading-two text-sm w-100">
                            ...
                            <div class="d-sm-none d-block w-100">
                                <div class="search-category select-style-one select-border-end-0 search-form text-heading-two text-sm d-flex flex-column">
                                    <select class="js-example-basic-single border border-neutral-40 border-end-0 mb-2"
                                        name="school">
                                        <option value="" selected disabled>Select School</option>
                                        @foreach($schools as $school)
                                            <option value="{{ $school->sch_id }}">{{ $school->sch_name }}</option>
                                    ...
                                    <select class="js-example-basic-single border border-neutral-40 border-end-0 mb-2" name="class">
                                        <option value="" selected disabled>Select Class</option>
                                        @foreach($classes as $class)
                                            <option value="{{ $class->class_id }}">{{ $class->class_name }}</option>
                                        @endforeach
                                    ...
                                    <select class="js-example-basic-single border border-neutral-40 border-end-0 mb-2" name="category">
                                        <option value="" selected disabled>Select Category</option>
                                        @foreach($categories as $category)
                                            <option value="{{ $category->cat_id }}">{{ $category->cat_name }}</option>
                                        @endforeach
